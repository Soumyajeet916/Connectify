  ...
  return (
    <div className="w-full no-scrollbar overflow-x-auto px-4">
      <div className="flex gap-4 pb-5">
        ...
        {/* Create Story card */}
        <div  onClick={()=>setShowModal(true)} className="rounded-lg shadow-sm min-w-[120px] max-w-[120px] max-h-[160px] aspect-[3/4] cursor-pointer hover:shadow-lg transition-all duration-200 border-2 border-dashed border-indigo-300 bg-gradient-to-b from-indigo-50 to-white">
        ...
        {stories.map((story, index) => (
          ...
          >
            ...
            {story.media_type !== 'text' && (
              <div className="absolute inset-0 rounded-lg overflow-hidden z-1 bg-black">
