    ...
    <div className="min-h-screen bg-slate-50">
      <div className="max-w-6xl mx-auto p-6">
        ...
        <div className="mb-8">
          ...
          <p className="text-slate-600">People you are connected with.</p>
        </div>
        ...
        {/* Tabs */}
        <div className="inline-flex flex-wrap items-center border border-gray-200 bg-white rounded-md p-1 shadow-sm">
          {dataArray.map((tab) => (
